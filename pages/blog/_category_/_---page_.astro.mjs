...
import { b as getPostCollections, g as getBlogCollection, d as getUniqueCategories, s as sortMDByDate, e as getCollectionsByCategory, f as getUniqueTags, c as config } from '../../../chunks/server_Cz41rmUb.mjs';
...
Collections
</h2> <ul class="flex flex-col gap-2"> ${postCollections.slice(0, 5).map((collection) => renderTemplate`${renderComponent($$result2, "CollectionPreview", $$CollectionPreview, { "collection": collection, "minimal": true })}`)} </ul> <span class="mt-4 block sm:text-end"> <a aria-label="View all collections" href="/collection" data-astro-prefetch>
View all →
...
}, "/Users/themaoqiu/CodeRepo/web/pure/Xingjian Wang/src/pages/blog/[category]/[...page].astro", void 0);

const $$file = "/Users/themaoqiu/CodeRepo/web/pure/Xingjian Wang/src/pages/blog/[category]/[...page].astro";
