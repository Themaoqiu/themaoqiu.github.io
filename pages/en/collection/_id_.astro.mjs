...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const posts = await getPostsForCollection(collection, true);
  const title = collection.data.title_en || collection.data.title;
  const description = collection.data.description_en || collection.data.description;
  const meta = {
    title,
    description
  };
...
}, "/Users/themaoqiu/CodeRepo/web/pure/Xingjian Wang/src/pages/en/collection/[id].astro", void 0);

const $$file = "/Users/themaoqiu/CodeRepo/web/pure/Xingjian Wang/src/pages/en/collection/[id].astro";
const $$url = "/en/collection/[id]";
