import { l as AstroError, E as ExpectedImage, L as LocalImageUsedWrongly, o as MissingImageDimension, U as UnsupportedImageFormat, I as IncompatibleDescriptorOptions, p as UnsupportedImageConversion, t as toStyleString, N as NoImageMetadata, q as FailedToFetchRemoteImageDimensions, v as ExpectedImageOptions, w as ExpectedNotESMImage, x as InvalidImageService, b as createAstro, c as createComponent, y as ImageMissingAlt, m as maybeRenderHead, e as addAttribute, s as spreadAttributes, a as renderTemplate, z as ExperimentalFontsNotEnabled, B as FontFamilyNotFound, u as unescapeHTML, C as UnknownContentCollectionError, R as RenderUndefinedEntryError, D as renderUniqueStylesheet, G as renderScriptElement, H as createHeadAndContent, r as renderComponent } from './astro/server_6pLgD4hd.mjs';
...
}, "/Users/themaoqiu/CodeRepo/web/pure/Xingjian Wang/node_modules/astro/components/Image.astro", void 0);
...
}, "/Users/themaoqiu/CodeRepo/web/pure/Xingjian Wang/node_modules/astro/components/Picture.astro", void 0);
...
}, "/Users/themaoqiu/CodeRepo/web/pure/Xingjian Wang/node_modules/astro/components/Font.astro", void 0);
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_C6u3nZXe.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://xingjianwang.github.io/", "SSR": true};
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DKO5s-tV.mjs');
...
async function getBlogCollectionEn() {
  ...
  const fallbackPosts = chinesePosts.filter((post) => {
    const match = post.id.match(/^(.+?)\/index\.(md|mdx)$/);
...
async function getPostsForCollection(collection, isEn = false) {
  ...
  return blogList.map((itemId) => postMap.get(itemId.toLowerCase())).filter((post) => post !== void 0);
}
...
function getAllCategories(collections) {
  return collections.map((collection) => collection.data.category).filter((category) => category !== void 0);
}
function getUniqueCategories(collections) {
  return [...new Set(getAllCategories(collections))];
}
function getCollectionsByCategory(collections, category) {
  return collections.filter((collection) => collection.data.category === category);
}

export { $$Image as $, groupCollectionsByYear as a, getPostCollections as b, config as c, getUniqueCategories as d, getCollectionsByCategory as e, getUniqueTags as f, getBlogCollection as g, getPostsForCollection as h, getCollection as i, getBlogCollectionEn as j, getUniqueTagsWithCount as k, integ as l, appendForwardSlash as m, joinPaths as n, getImage as o, baseService as p, parseQuality as q, renderEntry as r, sortMDByDate as s, terms as t };
